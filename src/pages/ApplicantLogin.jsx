...
const ApplicantLogin = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-neutral-900 transition-colors relative overflow-hidden">
      <video
        autoPlay
        loop
        muted
      ...
      <div className="relative z-10 w-full h-full">
        <SimpleNavbar />
        <div className="min-h-[calc(100vh-73px)] flex items-center justify-center px-8 bg-black/30">
